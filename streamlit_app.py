...
col2.markdown("""
#### After years of working in the industrial data engeering field, Otahy develop Canary Tech a concrete portofolio that will solve 3 exitising pain points of your business in a digital world. """)
